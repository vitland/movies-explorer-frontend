  ...
  return (
    <article className={styles.movieCard}>
      ...
      <div className={styles.movieCard__infoContainer}>
        ...
        {savedMoviesPage ?
          <button className={classNames(styles.movieCard__like, 'opacity_btn')} onClick={()=> onRemove(movie.id)}><Del /></button> :
        <button className={classNames(styles.movieCard__like, 'opacity_btn')} onClick={()=> onLike(
          { movie } )}><LikeBtn/></button>}
