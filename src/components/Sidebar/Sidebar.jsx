  ...
  return (
    <div className={classNames(styles.sidebar, { [styles.sidebar_active]:isOpened })}>
      <aside className={styles.sidebar__container}>
        <button className={classNames(styles.sidebar__closeBtn, 'opacity_btn')} onClick={()=>setIsOpened(!isOpened)} ><CloseIcon/></button>
        ...
        <Link to={'/profile'} className={classNames(styles.sidebar__link, styles.sidebar__link_profile, 'opacity_link')}>
          <span>Аккаунт</span>
