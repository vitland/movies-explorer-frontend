  ...
  return (
    <section id={'AboutProject'} className={styles.about}>
      ...
      <div className={styles.about__chart}>
        <p className={classNames(styles.about__chartText, styles.about__chartText_left)}>
          1 неделя
        </p>
        <p className={styles.about__chartSubtext}>Back-end</p>
        <p className={classNames(styles.about__chartText, styles.about__chartText_right)}>
          4 неделя
        </p>
